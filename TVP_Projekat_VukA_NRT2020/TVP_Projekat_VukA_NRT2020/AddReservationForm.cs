...
namespace TVP_Projekat_VukA_NRT2020
{
    public partial class AddReservationForm : Form
    {
        ...
        private void btnCreateReservation_Click(object sender, EventArgs e)
        {
            ...
            int idReservation = 0;
            if(ModelLister.Reservations.Count > 0)
            {
                idReservation = ModelLister.Reservations.ElementAt(ModelLister.Reservations.Count - 1).Id + 1;
            }

            ModelLister.Reservations.Add(new Reservation(idReservation, chosenGuest, chosenRoom, dateReservationFrom.Value, dateReservationTo.Value, price, cbPension.Text));
